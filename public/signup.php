...
<body>
                            ...
                            <form id="loginForm" class="auth-form" style="display: block;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control glass-input" id="loginEmail"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control glass-input" id="loginPassword"
                                ...
                                <button type="button" class="btn btn-google glass-btn w-100 mb-3"
                                    onclick="googleLogin()">
                                    <i class="fab fa-google me-2"></i> Continue with Google
                                </button>
                                <div class="text-center mt-4">
                                    <p class="switch-text"> Already have an account?
                                        <a href="login.php" onclick="switchForm('login')" class="switch-link">Sign
                                            In</a>
                                    </p>
                                </div>
                            ...
                            <form id="signupForm" class="auth-form" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control glass-input" id="signupName" name="name"
                                            placeholder="Enter your full name" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control glass-input" id="signupEmail"
                                            name="email" placeholder="Enter your email" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="password" class="form-control glass-input" id="signupPassword"
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function (e) {
            ...
            fetch('signup_process.php', {  // Changed from login_process.php
                method: 'POST',
                body: formData
            })
